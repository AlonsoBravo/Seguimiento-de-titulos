...
Route::group(['middleware' => ['rutasProfesorMiddleware']], function () {
    ...
    Route::post('guardar_proyecto','Proyectos\ProyectoController@guardarProyecto')->name('guardar_proyecto');   Route::get('/buscar_alumno_asignado','Proyectos\ProyectoController@comprobarAsignacionAlumno')->name('buscar_alumno_asignado');
